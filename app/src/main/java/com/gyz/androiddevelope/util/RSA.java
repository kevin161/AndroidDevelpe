...
public class RSA {
    ...
    public static Map<String, String> generateKeyPair() throws Exception {
        ...
        String pub = new String(Base64.encode(publicKeyBytes, Base64.NO_WRAP), "UTF-8");
        /** 得到私钥 */
        Key privateKey = kp.getPrivate();
        byte[] privateKeyBytes = privateKey.getEncoded();
        String pri = new String(Base64.encode(privateKeyBytes, Base64.NO_WRAP), "UTF-8");
    ...
    public static String encrypt(String source, String publicKey)
        ...
        return new String(Base64.encode(b1, Base64.NO_WRAP), "UTF-8");
    }
