...
import com.gyz.androiddevelope.activity.custom.FundActivity;
    ...
    public void OnClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.btnScrollTextView:
                startActivity(new Intent(getContext(), ScrollTextViewActivity.class));
                break;
            case R.id.btnCal:
                startActivity(new Intent(getContext(),FundActivity.class));
                break;
            case R.id.btnRSA:
                startActivity(new Intent(getContext(),ScaleViewActivity.class));
                break;
            case R.id.btnScaleView:
                startActivity(new Intent(getContext(),ScaleViewActivity.class));
                break;
