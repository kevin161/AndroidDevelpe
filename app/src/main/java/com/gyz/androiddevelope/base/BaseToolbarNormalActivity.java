 ...
 */
public abstract class BaseToolbarNormalActivity extends AppCompatActivity implements SwipeBackActivityBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        super.setContentView(R.layout.activity_base_toolbar_normal);
        initVariables();
        initToolbar();
